...
class Parser(argparse.ArgumentParser):
  def __init__(self):
    ...
    self.add_argument('--data_dir', type=str, default='/nfs02/users/aw847/data/denoising-fluorescent/', help='directory to dataset root')
    self.add_argument('--imsize', type=int, default=256)
    self.add_argument('--in_channels', type=int, default=1)
    self.add_argument('--out_channels', type=int, default=1)
    self.add_argument('--transform', type=str, default='four_crop', choices=['four_crop', 'center_crop'])
    self.add_argument('--noise_levels_train', type=list, default=[1])
    self.add_argument('--noise_levels_test', type=list, default=[1])
    ...
    self.add_argument('--arch', type=str, default='unet', choices=['unet', 'unroll'], help='arch of model')
    ...
    self.add_argument('--seed', type=int, default=0, help='Seed')
